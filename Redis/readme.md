...
![image-20200824144404619](./pictures/image-20200824144404619.png)
...
![image-20200802182911066](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20200802182911066.png)
...
![image-20201003230730804](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20201003230730804.png)
...
![image-20201003230742394](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20201003230742394.png)
...
![image-20201003230756256](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20201003230756256.png)
...
![image-20201003230834213](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20201003230834213.png)

![image-20201006212024415](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20201006212024415.png)

![image-20201006212315695](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20201006212315695.png)
...
![image-20201003231724543](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20201003231724543.png)

![image-20201003231507802](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20201003231507802.png)

![image-20201003231513771](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20201003231513771.png)
...
Redis hash是一个string类型的field和value的映射表，**hash特别适用于存储对象**。每个hash可以存储**232-1**(40亿左右)键值对。**可以看成KEY和VALUE的MAP容器【根据key值来找】**。相比于JSON，hash占用很少的内存空间。
...
![image-20201003231917362](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20201003231917362.png)

![image-20201003233438360](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20201003233438360.png)
...
![image-20201003233449991](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20201003233449991.png)

![image-20201003233556542](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20201003233556542.png)
...
![image-20201003233815934](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20201003233815934.png)
...
![image-20201003234718686](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20201003234718686.png)
...
![image-20201003234319067](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20201003234319067.png)

![image-20201003235006317](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20201003235006317.png)

![image-20201003235207272](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20201003235207272.png)

![image-20201003235222196](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20201003235222196.png)

![image-20201004000253017](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20201004000253017.png)
...
![image-20201006213853403](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20201006213853403.png)

![image-20201006214647974](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20201006214647974.png)

![image-20201006214945114](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20201006214945114.png)
...
![image-20200824110414225](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20200824110414225.png)
...
#rdb文件的名称，临时文件持久化完后将也会以这个名字替换原来的dump.rdb
dbfilename dump.rdb
 
#数据目录，数据库的写入会在这个目录。rdb、aof文件也会写在这个目录，持久化产生的临时文件rdb也在这个文件夹
dir /data
```
...
![image-20200913164423215](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20200913164423215.png)

![image-20200913164336474](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20200913164336474.png)
...
- save：save时只管保存，其他不管，全部阻塞【用了这个命令若还没持久化完，其它此时进来的命令全部阻塞】
- bgsave：redis会在后台异步的进行快照操作，同时还可以响应客户端请求。可以通过lastsave命令获取最后一次成功执行快照的事件【shutdown和flushall命令最后调用的都是这个命令bgsave】
...
![image-20200824110456308](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20200824110456308.png)

![image-20200913164955434](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20200913164955434.png)
...
### 布隆过滤器boomFilter，底层是一个位数组，整个数组默认是0

![image-20200915100442619](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20200915100442619.png)

下面有三个计算hash的算法，因此数组对应的下标有3个【index=hash("太白")】,有多少个计算下标的hash算法那数组就有多少个1

![image-20200915101215884](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20200915101215884.png)

hash冲突碰撞和数组长度与hash算法有关系【这两个属性会根据你自己初始化boomfilter输入的预计量和容错率自动生成】，比如像下面的111所hash得到的三个下标与其它已经存在的key键所hash得到的下标冲突了【要三个都冲突才算，只要有一个下标为0那就绝对不存在】，那就会出现误判可能存在

![image-20200915152914894](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20200915152914894.png)

布隆过滤器主要用来解决缓存穿透问题，以及set key value【value在底层是以二进制形式存储在位数组中，所以可以通过setbit命令根据key和下标来改变底层的二进制数组】

![image-20200915154142402](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20200915154142402.png)

<img src="C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20200915155027936.png" alt="image-20200915155027936" style="zoom:200%;" />
...
![image-20201006001349944](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20201006001349944.png)

![image-20201006001214762](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20201006001214762.png)

![image-20201006001237694](C:\Users\GWZ\AppData\Roaming\Typora\typora-user-images\image-20201006001237694.png)